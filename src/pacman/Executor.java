...
import pacman.entries.pacman.DavidPocockPacman;
...
public class Executor {
    ...
    public static void main(String[] args) {
        ...
        // From Damien: This is the version to run to get an estimated grade for your submission
        int numTrials = 10;
        ...
        int delay = 0;
        boolean visual = true;
        exec.runGame(new DavidPocockPacman(), new Legacy(), visual, delay);

        // run the game in asynchronous mode.
        exec.runGameTimed(new DavidPocockPacman(), new Legacy(), visual);
        ...
        exec.runGameTimedSpeedOptimised(new DavidPocockPacman(),new Legacy(), fixedTime, visual);

        // run game in asynchronous mode and record it to file for replay at a later stage.
        String fileName = "replay.txt";
        exec.runGameTimedRecorded(new HumanController(new KeyBoardInput()), new Legacy(), visual, fileName);
